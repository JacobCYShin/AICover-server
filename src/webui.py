    ...
    with gr.Blocks(title='AICoverGenWebUI') as app:
        ...
        with gr.Tab("Generate"):
            ...
            with gr.Accordion('Voice conversion options', open=False):
                ...
                use_uvr = gr.Checkbox(label='Use UVR Separation', info='Use UVR separation pipeline for higher quality vocal separation. Requires python-audio-separator to be installed.')
